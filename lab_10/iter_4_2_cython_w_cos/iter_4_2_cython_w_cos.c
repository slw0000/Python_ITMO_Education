...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "iter_4_2_cython_w_cos",
        "sources": [
            "iter_4_2_cython_w_cos.pyx"
        ]
    },
    "module_name": "iter_4_2_cython_w_cos"
}
END: Cython Metadata */
...
#define __PYX_HAVE__iter_4_2_cython_w_cos
#define __PYX_HAVE_API__iter_4_2_cython_w_cos
/* Early includes */
#include <math.h>
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "iter_4_2_cython_w_cos" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "iter_4_2_cython_w_cos"
extern int __pyx_module_is_main_iter_4_2_cython_w_cos;
int __pyx_module_is_main_iter_4_2_cython_w_cos = 0;

/* Implementation of "iter_4_2_cython_w_cos" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_21iter_4_2_cython_w_cos_integrate_cy_cos(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_kp_u_iter_4_2_cython_w_cos_pyx __pyx_string_tab[2]
...
#define __pyx_n_u_step __pyx_string_tab[24]
...
#define __pyx_kp_b_iso88591_r_1_j_wc_j_a_Cr_Ba_Bb_A_s_3b_Q __pyx_string_tab[28]
...
/* Python wrapper */
static PyObject *__pyx_pw_21iter_4_2_cython_w_cos_1integrate_cy_cos(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("integrate_cy_cos (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "integrate_cy_cos", 0) < (0)) __PYX_ERR(0, 3, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_cy_cos", 0, 2, 3, i); __PYX_ERR(0, 3, __pyx_L3_error) }
      }
    } else {
      switch (__pyx_nargs) {
        case  3:
    ...
    __pyx_v_a = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_n_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_n_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("integrate_cy_cos", 0, 2, 3, __pyx_nargs); __PYX_ERR(0, 3, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("iter_4_2_cython_w_cos.integrate_cy_cos", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21iter_4_2_cython_w_cos_integrate_cy_cos(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_21iter_4_2_cython_w_cos_integrate_cy_cos(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  double __pyx_v_acc;
  double __pyx_v_step;
  double __pyx_v_x;
  int __pyx_v_i;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("integrate_cy_cos", 0);

  /* "iter_4_2_cython_w_cos.pyx":21
 *         :return:         float.
 *     """
 *     if a > b:             # <<<<<<<<<<<<<<
 ...
 * 
*/
    __pyx_v_acc = (__pyx_v_acc + (cos(__pyx_v_x) * __pyx_v_step));

    /* "iter_4_2_cython_w_cos.pyx":34
 *         x = a + i * step
 *         acc += cos(x) * step
 *         i += 1             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "iter_4_2_cython_w_cos.pyx":36
 *         i += 1
 * 
 *     return acc             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_acc); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
static int __pyx_pymod_exec_iter_4_2_cython_w_cos(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_iter_4_2_cython_w_cos},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_iter_4_2_cython_w_cos(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_iter_4_2_cython_w_cos(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_iter_4_2_cython_w_cos(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'iter_4_2_cython_w_cos' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "iter_4_2_cython_w_cos" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_iter_4_2_cython_w_cos", 0);
  ...
  if (__pyx_module_is_main_iter_4_2_cython_w_cos) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "iter_4_2_cython_w_cos")) {
      if (unlikely((PyDict_SetItemString(modules, "iter_4_2_cython_w_cos", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *           `f`
*/
  __pyx_t_2 = __Pyx_PyLong_From_int(((int)0x3E8)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = PyTuple_Pack(1, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_21iter_4_2_cython_w_cos_1integrate_cy_cos, 0, __pyx_mstate_global->__pyx_n_u_integrate_cy_cos, NULL, __pyx_mstate_global->__pyx_n_u_iter_4_2_cython_w_cos, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_integrate_cy_cos, __pyx_t_2) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "iter_4_2_cython_w_cos.pyx":1
 * from libc.math cimport cos             # <<<<<<<<<<<<<<
 * 
 * def integrate_cy_cos(double a, double b, int n_iter=1000):
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init iter_4_2_cython_w_cos", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init iter_4_2_cython_w_cos");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{41},{25},{55},{20},{1},{3},{18},{1},{18},{8},{1},{16},{13},{5},{21},{8},{10},{6},{8},{3},{12},{12},{10},{4},{8},{6},{1},{113}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 