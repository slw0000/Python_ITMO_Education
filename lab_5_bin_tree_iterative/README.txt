...
Необходимо реализовать нерекурсивный (итеративный) вариант gen_bin_tree!
...
Построение дерева выполняется полностью итеративно в 3 шага.
1) Генерация списка со значениями веток и корней дерева
2) Преобразование всех элементов списка в dict, где ключ это элемент из списка, а значение пустой список
3) Преобразование списка словарей в один словарь
4) Вывод ответа.